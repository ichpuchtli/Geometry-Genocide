---
name: webgl-dev
description: WebGL development skill covering custom shaders, visual effects, GPU-accelerated rendering, resource management, context loss handling, performance optimization, and security considerations. Use for shader compilation, post-processing effects, particle systems, real-time visualization, and WebGL resource management.
---
...
This skill provides WebGL expertise for creating custom shaders and visual effects. It focuses on GPU-accelerated rendering with security considerations.
...
Key principles: handle context loss, enforce resource limits, validate shaders, track memory, batch draw calls, minimize state changes.
