...
function buildAlignmentManifest() {
  return {
    ...
    recommendations: [
      'Re-enable Triangle first because the source file already exists in Geometry Genocide and the Grid Wars asset/SFX identity is clear.',
...
- \`gridwars54-alignment.json\`: practical mapping between original Grid Wars concepts and the current Geometry Genocide roster/audio model.
